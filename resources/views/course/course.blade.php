...
<div class="page-content">
    <div class="page-content-inner">
                        ...
                        <div class="card-footer py-0 border-top-0">
                            <div class="row align-items-center text-center">
                                <div class="col-6 py-3">
                                    <a href="" class="text-muted" uk-toggle="target: #edit-modal"> Editar</a>
                                </div>
                                <div class="col-6 py-3">
        ...
        <!-- For Edit modal -->
            ...
            <div class="uk-modal-dialog uk-modal-body">
                <h2 class="uk-modal-title">Novo Curso</h2>
                <form id="user-form" method="POST" action="{{ route('course.update', $course->id) }}">
                    @csrf
                    <div class="card">
                        <div class="card-header border-bottom-0 py-4">
                            <h5> Configuração dos Cursos </h5>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="uk-switcher uk-margin" id="course-edit-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-9 m-auto">
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="course_title">Nome do Curso<span class="required">*</span></label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="fname" name="fname" value="{{$course->fname}}" placeholder="Digita o título do curso" value="" required="">
                                                    <input type="hidden" id="course_name" name="course_name" value="">
                                                    @csrf
                                                    @method('PUT')
                                                </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="short_description">Descrição</label>
                                                <div class="col-md-9">
                                                    <textarea name="description" id="description" class="form-control" value="{{$course->description}}" placeholder="..."></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <select class="selectpicker" value="{{$course->role}}" name="role" id="role">
                                                        <option value="free"> Grátis </option>
                                                        <option value="paid"> Pago </option>
                                                    </select>
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label">Preço ($)</label>
                                                <div class="col-md-9">
                                                    <input type="number" name="price" id="price" value="{{$course->price}}" class="form-control" placeholder="Digite o preço">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <select class="selectpicker" name="validate" value="{{$course->validate}}" id="validate">
                                                        <option value="lifetime"> Vitalício </option>
                                                        <option value="one_year"> 1 ano</option>
                                                    </select>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-9">
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="website_keywords">Nome do módulo</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="modulename" name="modulename" value="{{$module->modulename}}" style="width: 100%;">
                                                    <div class="bootstrap-tagsinput"><input size="1" type="text" placeholder="">
                                                    </div>
                                                </div>
                                ...
                                <li>
                                    <div class="row justify-content-center">
                                        <div class="col-xl-9">
                                            <input type="hidden" id="modulo_name" name="module_id" value="{{$lesson->module->name}}">

                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="website_keywords">Titulo</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="title_lesson" name="title_lesson" value="{{$lesson->title_lesson}}" placeholder="Título da aula">
                                                    <div class="bootstrap-tagsinput"><input size="1" type="text" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="short_description">Descrição</label>
                                                <div class="col-md-9">
                                                    <textarea name="description" id="description" value="{{$lesson->description}}" class="form-control" placeholder="..."></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="website_keywords">Nr da aula</label>
                                                <div class="col-md-9">
                                                    <input type="number" class="form-control" id="lesson_number" name="lesson_number" value="{{$lesson->lesson_number}}" data-role="tagsinput" style="width: 100%; display: none;">
                                                    <div class="bootstrap-tagsinput"><input size="1" type="text" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="website_keywords">Plataforma</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control bootstrap-tag-input" id="platform_name" name="platform_name" value="{{$lesson->platform_name}}" data-role="tagsinput" style="width: 100%; display: none;">
                                                    <div class="bootstrap-tagsinput"><input size="1" type="text" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="website_keywords">Link da aula</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control bootstrap-tag-input" id="video_link" name="video_link" data-role="tagsinput" value="{{$lesson->video_link}}" style="width: 100%; display: none;">
                                                    <div class="bootstrap-tagsinput"><input size="1" type="text" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
