                                    ...
                                    <div class="row align-items-center text-center">
                                        ...
                                        <div class="col-6 py-3">
                                            <button class="btn btn-outline-primary" type="button"
                                                uk-toggle="target: #modal-examp" data-course="{{ $value->name }}"
                                                data-price="{{ $value->price }}">Pagar</button>
                                ...
                                <ul class="uk-switcher uk-margin" id="course-edit-tab">
                                            ...
                                            <div class="col-xl-9 m-auto">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="fname"
                                                            name="fname" placeholder="Digita o título do curso"
                                                            value="" required="">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label"
                                                        for="short_description">Descrição</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="user_id"> Instrutor <span
                                                        ...
                                                        <div class="uk-position-relative my-4">
                                                            ...
                                                            <div class="uk-position-center">
                                                                <div uk-form-custom="">
                                                                    ...
                                                                    <span
                                                                        class="uk-link icon-feather-camera icon-medium text-black">
                                                                    </span>
                                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-9">
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="website_keywords">Nome do
                                                        módulo</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="modulename"
                                                            name="modulename" style="width: 100%;">
                                                    </div>
                                    ...
                                    <li>
                                        <div class="row justify-content-center">
                                            <div class="col-xl-9">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label"
                                                        for="website_keywords">Titulo</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="title_lesson"
                                                            name="title_lesson" placeholder="Título da aula">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="website_keywords">Nr da
                                                        aula</label>
                                                    <div class="col-md-9">
                                                        <input type="number" class="form-control" id="lesson_number"
                                                            name="lesson_number" data-role="tagsinput"
                                                            style="width: 100%;">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label"
                                                        for="website_keywords">Plataforma</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control bootstrap-tag-input"
                                                            id="platform_name" name="platform_name" data-role="tagsinput"
                                                            style="width: 100%;">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control bootstrap-tag-input"
                                                            id="video_link" name="video_link" data-role="tagsinput"
                                                            style="width: 100%; ">
                                        ...
                                        <div class="row">
                                            <div class="col-12 my-lg-5">
                                                <div class="text-center">
                                                    <h2 class="mt-0"><i
                                                            class="icon-feather-check-circle text-success"></i></h2>
