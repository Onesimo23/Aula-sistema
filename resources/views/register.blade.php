    ...
    <div uk-height-viewport="expand: true" class="uk-flex uk-flex-middle">
        <div class="uk-width-1-3@m uk-width-1-2@s m-auto">
            <div class="uk-card-default p-5 rounded">
                ...
                <form class="uk-child-width-1-1 uk-grid-small" uk-grid="" action="{{ route('register') }}" method="POST">
                    @csrf 
                     <div>
                        <div class="uk-form-group">
                            ...
                            <div class="uk-position-relative w-100">
                                ...
                                <input class="uk-input" type="text" placeholder="Full name" name="name">
                            </div>
                        </div>
                    </div>
                    <div>
                    ...
                    <!-- <div>
                        <div class="uk-form-group">
                            <label class="uk-form-label">Are you an admin?</label>
                            <div class="uk-position-relative w-100">
                                <input type="checkbox" id="is_admin" name="is_admin" value="1">
                                <label for="is_admin">Yes, I am an admin</label>
                            </div>
                        </div>
                    </div>
                    <div> -->
