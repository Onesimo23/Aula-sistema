                                        ...
                                        <div class="media align-items-center">
                                            <div>
                                                <div class="avatar-parent-child" style="width: max-content">
                                                    <img alt="Image placeholder" src="..\assets\images\avatars\avatar-2.jpeg" class="avatar  rounded-circle">
                                        ...
                                        <div class="media align-items-center">
                                            <div>
                                                <div class="avatar-parent-child">
                                                    <img alt="Image placeholder" src="..\assets\images\avatars\avatar-3.jpeg" class="avatar  rounded-circle">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="media align-items-center">
                                            <div>
                                                <div class="avatar-parent-child">
                                                    <img alt="Image placeholder" src="..\assets\images\avatars\avatar-4.jpeg" class="avatar  rounded-circle">
                                                    <span class="avatar-child avatar-badge bg-light"></span>
                                                </div>
                                            </div>
                                            <div class="media-body ml-4">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="media align-items-center">
                                            <div>
                                                <div class="avatar-parent-child">
                                                    <img alt="Image placeholder" src="..\assets\images\avatars\avatar-1.jpeg" class="avatar  rounded-circle">
                                                    <span class="avatar-child avatar-badge bg-success"></span>
                                                </div>
                                            </div>
                                            <div class="media-body ml-4">
